      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex justify-between items-center">
          <a href="/" className="hover:opacity-80 transition-opacity">
            <div>
              <h1 className="text-2xl font-bold text-gray-300 font-mono tracking-wider">REWARDFLOW BURN</h1>
              <p className="text-xs text-red-400 font-mono tracking-widest">[AUTOMATED BURN ALGORITHM]</p>
            </div>
          </a>
          <div className="flex items-center space-x-6">
            <button
              className="bg-red-400 text-black px-4 py-2 rounded font-mono text-sm font-semibold hover:bg-yellow-400 transition-colors tracking-wider cursor-pointer"
              onClick={() => handleSectionClick('burn-history')}
            >
              BURN HISTORY
            </button>
            <button
            ...
            <a
              ...
              className="flex items-center space-x-2 text-red-400 hover:text-yellow-400 transition-colors font-mono text-sm tracking-wider"
            >
              <svg
