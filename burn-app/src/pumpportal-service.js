        ...
        try {
            ...
            if (data.signature) {
                ...
                if (txSuccess) {
                    ...
                    // Estimate tokens received (PumpPortal doesn't return exact amount)
                    // For Pump.fun tokens, this is an approximation
                    const estimatedTokens = Math.floor(solAmount * 1000000); // Rough estimate
